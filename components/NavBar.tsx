...
function NavBar() {
  return (
    <div className='text-red-500 '>
        ...
        <div className="w-screen bg-red-500 h-[40px] grid justify-center items-center text-center text-white text-[15px]"> Free delevery for all orders over $50. Order your food now!</div>
